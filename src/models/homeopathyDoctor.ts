...
export interface HomeopathyDoctorDocument extends mongoose.Document {
  numeric_id: string;
  picture_url: string;
  name: string;
  phone: string;
...
homeopathyDoctorSchema.methods.generateAuthToken = function() {
  const doctor = this as HomeopathyDoctorDocument; 
...
const HomeopathyDoctor = mongoose.model<HomeopathyDoctorDocument>('HomeopathyDoctor', homeopathyDoctorSchema);

export default HomeopathyDoctor;
